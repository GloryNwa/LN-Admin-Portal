                        ...
                        @if(count($information)==1)
                            ...
                            <div class="col-md-5 col-sm-12 col-lg-5">
                                ...
                                <div class="trfc-cnt">
                                    ...
                                    <p>{{substr($information->description,0,250)}}</p>
                            ...
                            <div class="col-md-7 col-sm-12 col-lg-7">
                                <div class="traffic-chart-wrp"><br><br>
                                    @if(!empty($information->file))
                                        <div><img src="{{ URL::to("/").$information->file}}" style="width:100%;" class="img-thumbnail"/></div>
                                    @else
                                            ...
                                            <div class="serv-inkkkf">
                                              <div id="data">
                                                ...
                                                @if($resource->file_type == 'video')
                                                    ...
                                                    <a href="/watch/resource/{{$resource->id}}" ><button class="btn btn-danger btn-xs" style="background-color: #009efb;border:none;">Play Video <i class="fa fa-play"></i></button></a>
                            ...
                            @if(count($events) > 0)
                                ...
                                @foreach($events as $event)
                                    ...
                                    <tr class="resource-holder">
                                        ...
                                        <td>
                                            <h4 class="date"><a href="{{route('all_events')}}">{{$event['title']}}</a></h4>
                                        </td>
                                        <td>
                                            <span class="name"><a href="{{route('all_events')}}">{{substr($event['description'],0,60)}}</a></span>
                                        </td>
                                        <td>
