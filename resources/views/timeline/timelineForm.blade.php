...
<div class="container" style="max-width: 700px; padding-top:70px ">
    <div class="panel-content">
        <div class="widget pad40-50">
            ...
            <form class="form-wrp" method="POST" action="{{route('addtimeline')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group">
                    ...
                    <div class="row mrg15">
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <textarea class="brd-rd5" type="text" name="text_body" placeholder="Message*" required="required" /></textarea>
                        </div>
                        <div class="col-md-12 col-sm-12 col-lg-12">
                            <div class="form-group">
