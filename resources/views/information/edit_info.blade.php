 ...
 <div class="container" style="max-width: 700px; padding-top:70px ">
  <div class="panel-content">
    <div class="widget pad40-50"> 
      ...
      <form class="form-wrp" method="POST" action="{{ route('editInfo', array($information->id)) }}" enctype="multipart/form-data">
      {{ csrf_field() }}
       <div class="form-group">
         <input type="hidden" name="MAX_FILE_SIZE" value="1000000"> <br>
        <div class="row mrg15">
          <div class="col-md-12 col-sm-12 col-lg-12">
            <input class="brd-rd5" type="text" name="title" value="{{ $information->title}}" placeholder="Title*" />
          </div>
          <div class="col-md-12 col-sm-12 col-lg-12">
            <textarea class="brd-rd5" type="text" name="description" placeholder="Message*" value="{{$information->description}}" >{{$information->description}}</textarea>
          </div>
          <div class="col-md-12 col-sm-12 col-lg-12">
           <div class="form-group">
